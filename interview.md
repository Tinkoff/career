...
В рамках секции проверяем знания по алгоритмам и структурам данных. Для SRE предлагаем решить задачу на реализацию, например, сделать клиент с бизнес-логикой для сетевых API.
